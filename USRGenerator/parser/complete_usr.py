...
def call_packages(filename):
    os.system("isc-parser -i"+filename+" > ./USRGenerator/parser/txt_files/parser-output.txt")
    os.system("utf8_wx "+filename+" > ./USRGenerator/parser/txt_files/wx.txt")
    os.system("python2.7 ./USRGenerator/parser/getMorphPruneAndNER.py -i"+filename+" -o ./USRGenerator/parser/txt_files/prune-output.txt")
def call_usr_program():
    os.system("python3 ./USRGenerator/parser/generate_usr.py>./USRGenerator/parser/hellow.txt")
